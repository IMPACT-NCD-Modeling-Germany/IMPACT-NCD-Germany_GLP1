...
analysis_name <- "GLP_Final_Analysis_Test" ### create a folder to store all the output in this folder

# Define directories
lifecourse_dir <- "/mnt/Storage_1/IMPACT_Storage/GLP1/outputs/GLP_Final_Analysis_Test/lifecourse" 
...
export_types <- c("le", "ly", "prvl", "incd",
                  "mrtl",  "dis_mrtl", "xps", "cea")

if(new_export){
  IMPACTncd$export_summaries(multicore = TRUE, type = export_types) 
} 
