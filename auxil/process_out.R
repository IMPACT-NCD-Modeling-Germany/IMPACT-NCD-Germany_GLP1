...
if(Sys.info()["sysname"] == "Windows"){
  ...
  dirs <- list.dirs("/media/php-workstation/Storage_2/IMPACT_Storage/GLP1/outputs/",
                    recursive = FALSE, full.names = FALSE)
}
...
for(analysis in dirs){
    ...
    if(!Sys.info()[1] == "Windows"){
      ...
      in_path <- paste0("/media/php-workstation/Storage_2/IMPACT_Storage/GLP1/outputs/", analysis, "/summaries/")
      
      # Output path for tables
      out_path_tables <- paste0("/media/php-workstation/Storage_2/IMPACT_Storage/GLP1/outputs/", analysis, "/tables/")
      
      # Output path for plots
      out_path_plots <- paste0("/media/php-workstation/Storage_2/IMPACT_Storage/GLP1/outputs/", analysis, "/plots/")
